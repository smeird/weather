...
//		location.hash = currentHash;
        ...
        function slidePages(fromPage, toPage, backwards)
        {
            ...
            function slideDone()
            {
                ...
                if (backwards)
                    sendEvent("unload", fromPage);	// EVENT: UNLOAD
            }
        }
        ...
        function submitForm(form)
        {
            ...
            iui.showPageByHref(form.getAttribute('action'), encodeForm(form), form.hasAttribute('method') ? form.getAttribute('method') : 'GET', null, function() {
                iui.removeClass(form, "progress")
            });
        }
