    ...
    (function() {
        ...
        function X(a,
            ...
            a = I.createElement(a);
            b && y(a, b);
            e && H(a, {padding: 0, border: Y, margin: 0});
            c && H(a, c);
            d && d.appendChild(a);
            return a
        }
        ...
        function Qa(a, b, c, d) {
            ...
            var b = a, c = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = f < 0 ? "-" : "", a = String(A(f = U(+f || 0).toFixed(b))), g = a.length > 3 ? a.length % 3 : 0;
        ...
        function vb(a, b) {
            var c =
                    b || [[fb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [Xa, [1, 2, 5, 10, 15, 30]], [Ra, [1, 2, 5, 10, 15, 30]], [ra, [1, 2, 3, 4, 6, 8, 12]], [da, [1, 2]], [Ea, [1, 2]], [Fa, [1, 2, 3, 4, 6]], [ma, null]], d = c[c.length - 1], e = G[d[0]], f = d[1], g;
        ...
        function Ya(a, b, c, d) {
            ...
            if (s(b)) {
                ...
                if (j >= G[Ra])
                    i[Kb](j >= G[ra] ? 0 : k * W(i[wb]() / k));
                if (j >= G[ra])
                    i[Lb](j >= G[da] ? 0 : k * W(i[xb]() / k));
                if (j >= G[da])
                    i[yb](j >= G[Fa] ? 1 : k * W(i[Ga]() / k));
                j >= G[Fa] && (i[Mb](j >= G[ma] ? 0 : k * W(i[gb]() / k)), h = i[hb]());
                j >= G[ma] && (h -= h % k, i[Nb](h));
                if (j === G[Ea])
                    i[yb](i[Ga]() - i[zb]() + n(d, 1));
                b = 1;
                h = i[hb]();
                for (var d = i.getTime(), l = i[gb](), m = i[Ga](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
                    e.push(d), j === G[ma] ? d = ib(h + b * k, 0) : j === G[Fa] ? d = ib(h, l + b * k) :
        ...
        var v, I = document, S = window, L = Math, x = L.round, W = L.floor, Ka = L.ceil, w = L.max, K = L.min, U = L.abs, ba = L.cos, fa = L.sin, La = L.PI, kb = La * 2 / 360, ua = navigator.userAgent, Ub = S.opera,
        ...
        }, Va = [], na = "div", Y = "none", Gb = "rgba(192,192,192," + (ja ? 1.0E-4 : 0.002) + ")", fb = "millisecond",
                Xa = "second", Ra = "minute", ra = "hour", da = "day", Ea = "week", Fa = "month", ma = "year", Hb = "stroke-width", ib, wb, xb, zb, Ga, gb, hb, Kb, Lb, yb, Mb, Nb, R = {};
        S.Highcharts = {};
        xa = function(a, b, c) {
            if (!s(b) || isNaN(b))
                return"Invalid date";
            var a = n(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b), e, f = d[xb](), g = d[zb](), h = d[Ga](), i = d[gb](), j = d[hb](), k = P.lang, l = k.weekdays, b = {a: l[g].substr(0, 3), A: l[g], d: Da(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Da(i + 1), y: j.toString().substr(2, 2), Y: j, H: Da(f), I: Da(f % 12 || 12), l: f % 12 || 12, M: Da(d[wb]()), p: f < 12 ? "AM" :
                        "PM", P: f < 12 ? "am" : "pm", S: Da(d.getSeconds()), L: Da(x(b % 1E3), 3)};
            for (e in b)
                for (; a.indexOf("%" + e) !== - 1; )
                    a = a.replace("%" + e, b[e]);
            return c ? a.substr(0, 1).toUpperCase() + a.substr(1) : a
        };
        Ob.prototype = {wrapColor: function(a) {
                if (this.color >= a)
                    this.color = 0
        ...
        var N = S.HighchartsAdapter, E = N || {};
        N && N.init.call(N, Fb);
        var ob = E.adapterRun,
                cc = E.getScript, dc = E.inArray, q = E.each, Wb = E.grep, ec = E.offset, Ma = E.map, z = E.merge, C = E.addEvent, O = E.removeEvent, J = E.fireEvent, Xb = E.washMouseEvent, Ib = E.animate, pb = E.stop, E = {enabled: !0, align: "center", x: 0, y: 15, style: {color: "#666", fontSize: "11px", lineHeight: "14px"}};
        P = {colors: "#4572A7,#AA4643,#89A54E,#80699B,#3D96AE,#DB843D,#92A8CD,#A47D7C,#B5CA92".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","),
            ...
            plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, shadow: !0, marker: {enabled: !0, lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: z(E, {enabled: !1, formatter: function() {
                            return this.y
                ...
                shadow: !0, shared: aa, snap: nb ? 25 : 10, style: {color: "#333333", fontSize: "12px", padding: "5px", whiteSpace: "nowrap"}}, credits: {enabled: !0, text: "Highcharts.com", href: "http://www.highcharts.com", position: {align: "right", x: -10, verticalAlign: "bottom", y: -5}, style: {cursor: "pointer", color: "#909090", fontSize: "10px"}}};
        ...
        var ya = function(a) {
            ...
            (function(a) {
                (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(a)) ? b = [A(c[1]), A(c[2]),
                    A(c[3]), parseFloat(c[4], 10)] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) && (b = [A(c[1], 16), A(c[2], 16), A(c[3], 16), 1])
            })(a);
        ...
        Ja.prototype = {init: function(a, b) {
                ...
                var c, d, e, f, g = this.element, h = g.nodeName.toLowerCase(), i = this.renderer, j, k = this.attrSetters, l = this.shadows, m, o, p = this;
                pa(a) && s(b) && (c = a, a = {}, a[c] = b);
                if (pa(a))
                    c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), p = F(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (p = parseFloat(p));
                else
                    for (c in a)
                        if (j =
                            ...
                            if (c === "d")
                                ...
                                for (e = 0; e < g.childNodes.length; e++)
                                    f = g.childNodes[e], F(f, "x") === F(g, "x") && F(f, "x", d);
                                ...
                                F(g, {rx: d, ry: d}), j = !0;
                                    ...
                                    c === "translateY" || c === "rotation" || c === "verticalAlign")
                                j = o = !0;
                            else if (c === "stroke")
                                d = i.color(d, g, c);
                            else if (c === "dashstyle")
                                ...
                                e = g.getElementsByTagName("title")[0], e || (e = I.createElementNS(va, "title"), g.appendChild(e)), e.textContent = d;
                            c === "strokeWidth" && (c = "stroke-width");
                            if (c === "stroke-width" && d === 0 && (lb || i.forExport))
                                d = 1.0E-6;
                            ...
                            if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
                                for (e =
                                        l.length; e--; )
                                    F(l[e], c, c === "height" ? w(d - (l[e].cutHeight || 0), 0) : d);
                ...
                if (this.added) {
                    ...
                    if (c || d)
                        H(b, {marginLeft: c, marginTop: d}), j && q(j, function(a) {
                    ...
                    if (b.tagName === "SPAN") {
                        var k, l, j = this.rotation, m, o = 0, p = 1, o = 0, t;
                        m = A(this.textWidth);
                        var r = this.xCorr || 0, ga = this.yCorr || 0, M = [j, g, b.innerHTML, this.textWidth].join(",");
                        k = {};
                        if (M !== this.cTT) {
                            if (s(j))
                                a.isSVG ? (r = Pa ? "-ms-transform" : lb ? "-webkit-transform" : mb ? "MozTransform" : Ub ? "-o-transform" : "", k[r] = k.transform = "rotate(" + j + "deg)") : (o = j * kb, p = ba(o), o = fa(o), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", p, ", M12=", -o, ", M21=", o, ", M22=", p, ", sizingMethod='auto expand')"].join("") : Y), H(b, k);
                            k = n(this.elemWidth, b.offsetWidth);
                            l = n(this.elemHeight, b.offsetHeight);
                            if (k > m && /[ \-]/.test(b.textContent || b.innerText))
                                H(b, {width: m + "px", display: "block", whiteSpace: "normal"}),
                                k = m;
                            ...
                            r += o * m * (t ? 1 - h : h);
                            ga -= p * m * (j ? t ? h : 1 - h : 1);
                            i && (r -= k * h * (p < 0 ? -1 : 1), j && (ga -= l * h * (o < 0 ? -1 : 1)), H(b, {textAlign: g}));
                            this.xCorr = r;
                            this.yCorr = ga
                        }
                        H(b, {left: e + r + "px", top: f + ga + "px"});
                        if (lb)
                            l = b.offsetHeight;
                        this.cTT = M
                    }
                ...
                if (!a) {
                    ...
                    if (b.isSVG) {
                        b = a.width;
                        c = a.height;
                        if (Pa && e && e.fontSize === "11px" && c === 22.700000762939453)
                            a.height = c = 14;
                        if (d)
                            a.width = U(c * fa(f)) + U(b * ba(f)), a.height = U(c * ba(f)) + U(b * fa(f))
                    }
                    this.bBox = a
                }
                return a
                ...
                var b = this.renderer, c = a || b, d = c.element || b.box, e = d.childNodes, f = this.element, g = F(f, "zIndex"), h;
                if (a)
                    this.parentGroup = a;
                this.parentInverted =
                        a && a.inverted;
                ...
                if (a) {
                    ...
                    for (e = 1; e <= i; e++) {
                        f =
                                g.cloneNode(0);
                        h = i * 2 + 1 - 2 * e;
                        F(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: Y});
                        if (c)
                            F(f, "height", w(F(f, "height") - h, 0)), f.cutHeight = h;
        ...
        oa.prototype = {Element: Ja, init: function(a, b, c, d) {
                var e = location, f;
                f = this.createElement("svg").attr({xmlns: va, version: "1.1"});
                ...
                this.setSize(b, c, !1);
                var g;
                if (mb && a.getBoundingClientRect)
                    this.subPixelFix = b = function() {
                        H(a, {left: 0, top: 0});
                        g = a.getBoundingClientRect();
                        H(a, {left: Ka(g.left) - g.left + "px", top: Ka(g.top) - g.top + "px"})
                    }, b(), C(S, "resize", b)
            }, isHidden: function() {
            ...
            destroy: function() {
                ...
                for (var b = a.element, c = n(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                        "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = F(b, "x"), h = a.styles, i = h && h.width && A(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--; )
                    b.removeChild(d[h]);
                i && !a.added && this.box.appendChild(b);
                c[c.length - 1] === "" && c.pop();
                q(c, function(c, d) {
                    var h, t = 0, r, c = c.replace(/<span/g, "|||<span").replace(/<\/span>/g, "</span>|||");
                    h = c.split("|||");
                    q(h, function(c) {
                        if (c !== "" || h.length === 1) {
                            var m = {}, n = I.createElementNS(va, "tspan"), q;
                            e.test(c) &&
                                    (q = c.match(e)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), F(n, "style", q));
                            f.test(c) && (F(n, "onclick", 'location.href="' + c.match(f)[1] + '"'), H(n, {cursor: "pointer"}));
                            c = (c.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                            n.appendChild(I.createTextNode(c));
                            t ? m.dx = 3 : m.x = g;
                            if (!t) {
                                if (d) {
                                    !ja && a.renderer.forExport && H(n, {display: "block"});
                            ...
                            t++;
                            if (i)
                                for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), B = []; c.length || B.length; )
                                    delete a.bBox, D = a.getBBox().width, m = D > i, !m || c.length === 1 ? (c = B, B = [], c.length && (n = I.createElementNS(va, "tspan"), F(n, {dy: j || 16, x: g}), q && F(n, "style", q), b.appendChild(n), D > i && (i = D))) : (n.removeChild(n.firstChild), B.unshift(c.pop())), c.length && n.appendChild(I.createTextNode(c.join(" ").replace(/- /g,
                                            "-")))
                        }
                    })
                })
            }, button: function(a, b, c, d, e, f, g) {
                var h = this.label(a, b, c), i = 0, j, k, l, m, o, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = z(ha(Hb, 1, "stroke", "#999", "fill", ha("linearGradient", a, "stops", [[0, "#FFF"], [1, "#DDD"]]), "r", 3, "padding", 3, "style", ha("color", "black")), e);
                l = e.style;
                delete e.style;
                f = z(e, ha("stroke", "#68A", "fill", ha("linearGradient", a, "stops", [[0, "#FFF"], [1, "#ACF"]])), f);
                m = f.style;
                delete f.style;
                g = z(e, ha("stroke", "#68A", "fill", ha("linearGradient", a, "stops", [[0, "#9BD"], [1, "#CDF"]])), g);
                o = g.style;
                delete g.style;
            ...
            circle: function(a, b, c) {
                ...
                e = ea(a) ? a.r : e;
                e = this.createElement("rect").attr({rx: e, ry: e, fill: Y});
                ...
                for (this.boxWrapper[n(c,
                        !0)?"animate":"attr"]({width:a, height:b}); e--; )
                    d[e].align()
            }, g: function(a) {
                ...
                var g, h = this.symbols[a], h = h && h(x(b),
                        x(c), d, e, f), i = /^url\((.*?)\)$/, j, k;
                h ? (g = this.path(h), y(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && y(g, f)) : i.test(a) && (k = function(a, b) {
                    a.element && (a.attr({width: b[0], height: b[1]}), a.alignByTranslate || a.translate(x((d - b[0]) / 2), x((e - b[1]) / 2)))
                }, j = a.match(i)[1], a = Vb[j], g = this.image(j).attr({x: b, y: c}), a ? k(g, a) : (g.attr({width: 0, height: 0}), X("img", {onload: function() {
                ...
                return g
                    ...
                    var f = e.start, c = e.r || c || d, g = e.end - 1.0E-6, d = e.innerR, h = e.open, i = ba(f), j = fa(f), k = ba(g), g = fa(g), e = e.end - f < La ? 0 : 1;
                    return["M", a + c * i,
                ...
                if (g) {
                    ...
                    j = a.stops;
                    b = b.radialReference;
                    Wa(c) && (a[g] = c = {x1: c[0], y1: c[1], x2: c[2],
                        y2: c[3], gradientUnits: "userSpaceOnUse"});
                    g === "radialGradient" && b && !s(c.gradientUnits) && y(c, {cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: "userSpaceOnUse"});
                    for (m in c)
                        m !== "id" && o.push(m, c[m]);
                    for (m in j)
                        o.push(j[m]);
                    ...
                    return f.test(a) ? (e = ya(a), F(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a)
            }, text: function(a, b, c, d) {
                var e = P.chart.style, f = aa || !ja && this.forExport;
                if (d && !this.forExport)
                ...
                var d =
                        P.chart.style, e = this.createElement("span"), f = e.attrSetters, g = e.element, h = e.renderer;
                f.text = function(a) {
                ...
                e.attr({text: a, x: x(b), y: x(c)}).css({position: "absolute", whiteSpace: "nowrap", fontFamily: d.fontFamily, fontSize: d.fontSize});
                e.css = e.htmlCss;
                if (h.isSVG)
                    e.add = function(a) {
                        ...
                        if (a) {
                            if (b = a.div, !b) {
                                ...
                                q(d.reverse(), function(a) {
                                    var d;
                                    b = a.div = a.div || X(na, {className: F(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                                    d = b.style;
                ...
                var a = A(a || 11), a = a < 24 ? a + 4 : x(a * 1.2), b = x(a * 0.8);
                return{h: a, b: b}
            }, label: function(a,
                    b, c, d, e, f, g, h, i) {
                function j() {
                    ...
                    if (Jb) {
                        if (!r)
                            a = h ? -eb : 0, p.box = r = d ? o.symbol(d, -M * u, a, p.width, p.height) : o.rect(-M * u, a, p.width, p.height, 0, qb[Hb]), r.add(p);
                        r.attr(z({width: p.width, height: p.height}, qb));
                        qb = null
                    }
                }
                function k() {
                    var a = p.styles, a = a && a.textAlign, b = u * (1 - M), c;
                    c = h ? 0 : eb;
                    if (s(w) && (a === "center" || a === "right"))
                ...
                function m() {
                    ...
                    r && s(e) && p.attr({anchorX: e, anchorY: f})
                }
                var o = this, p = o.g(i), t = o.text("", 0, 0, g).attr({zIndex: 1}), r, n, M = 0, u = 3, w, D, B, Z, Yb = 0, qb = {}, eb, g = p.attrSetters, Jb;
                C(p, "add", m);
                g.width = function(a) {
                    w = a;
                    return!1
                ...
                return y(p, {css: function(a) {
                        ...
                        return{width: n.width + 2 * u, height: n.height + 2 * u, x: n.x - u, y: n.y - u}
                    }, shadow: function(a) {
                        r && r.shadow(a);
                        return p
                    }, destroy: function() {
        ...
        if (!ja && !aa) {
            var ca = {init: function(a, b) {
                    ...
                    c.push(' style="', d.join(""), '"/>');
                    if (b)
                        c = b === na || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = X(c);
                    this.renderer = a;
                    this.attrSetters = {}
                }, add: function(a) {
                ...
                updateTransform: Ja.prototype.htmlUpdateTransform, attr: function(a, b) {
                    var c, d, e, f = this.element || {}, g = f.style, h = f.nodeName, i = this.renderer, j = this.symbolName, k, l = this.shadows, m, o = this.attrSetters, p = this;
                    pa(a) && s(b) && (c = a, a = {}, a[c] = b);
                    if (pa(a))
                        ...
                        for (c in a)
                            if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                                ...
                                if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
                                    ...
                                    e = d.length;
                                    for (m = []; e--; )
                                        m[e] = Ba(d[e]) ? x(d[e] * 10) - 5 : d[e] === "Z" ? "x" : d[e];
                                    d = m.join(" ") || "x";
                                    f.path = d;
                                    if (l)
                                        for (e = l.length; e--; )
                                    ...
                                    d = w(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) :
                                            g[c] = d, m = !0;
                                else if (c === "x" || c === "y")
                                    ...
                                    f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ba(d) && (d += "px");
                                else if (c === "dashstyle")
                                    (f.getElementsByTagName("stroke")[0] || X(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0;
                                else if (c === "fill")
                                    if (h === "SPAN")
                                        g.color = d;
                                    else {
                                        if (h !== "IMG")
                                            f.filled = d !== Y ? !0 : !1, d = i.color(d,
                                                    f, c, this), c = "fillcolor"
                                    }
                                else if (h === "shape" && c === "rotation")
                                    this[c] = d, f.style.left = -x(fa(d * kb) + 1) + "px", f.style.top = x(ba(d * kb)) + "px";
                    ...
                    a ? (c = a.members, Ca(c, b), c.push(b), b.destroyClip = function() {
                        Ca(c, b)
                    }, e && e.className === "highcharts-tracker" && !cb && H(d, {visibility: "hidden"}),
                    ...
                    var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, m, o, p;
                    ...
                    if (a) {
                        ...
                        for (e = 1; e <= 3; e++) {
                            ...
                            h = X(g.prepVML(j), null,
                                    {left: A(i.left) + n(a.offsetX, 1), top: A(i.top) + n(a.offsetY, 1)});
                            if (c)
                                h.cutOff = l + 1;
                    ...
                    return this
                }}, ca = $(Ja, ca), ca = {Element: ca, isIE8: ua.indexOf("MSIE 8.0") > -1, init: function(a, b, c) {
                    var d, e;
                    this.alignedObjects = [];
                    ...
                    this.setSize(b,
                            c, !1);
                    if (!I.namespaces.hcv)
                        I.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), I.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
                }, isHidden: function() {
                    ...
                    return y(e, {members: [], left: f ? a.x : a, top: f ? a.y : b, width: f ? a.width : c, height: f ? a.height : d, getCSS: function(a) {
                            var b = a.inverted, c = this.top, d = this.left, e = d + this.width, f = c + this.height,
                                    c = {clip: "rect(" + x(b ? d : c) + "px," + x(b ? f : e) + "px," + x(b ? e : f) + "px," + x(b ? c : d) + "px)"};
                            !b && cb && a.element.nodeName !== "IMG" && y(c, {width: e + "px", height: f + "px"});
                            return c
                    ...
                    var e = this, f, g = /^rgba/, h, i, j = Y;
                    a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
                    if (i) {
                        var k, l, m = a.linearGradient || a.radialGradient, o, p, t, r, n, M = "", a = a.stops, u, v = [], D = function() {
                        ...
                        if (c === "fill")
                            if (i === "gradient")
                                c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, M = 'angle="' + (90 - L.atan((m - a) / (o - c)) * 180 / La) + '"', D();
                            else {
                                var j = m.r, B = j * 2, Z = j * 2, s = m.cx, w = m.cy, x = b.radialReference,
                                        z, j = function() {
                        ...
                        f = ya(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], X(this.prepVML(h), null, null, b), j = f.get("rgb");
                    else {
                    ...
                    return a
                }, text: oa.prototype.html, path: function(a) {
                    ...
                    H(a, {flip: "x",
                        ...
                        var f = e.start, g = e.end, h = e.r || c || d, c = ba(f), d = fa(f), i = ba(g), j = fa(g), k = e.innerR, l = 0.08 / h, m = k && 0.1 / k || 0;
                        if (g - f === 0)
                            return["x"];
                        else
                            2 * La - g + f < l ? i = -l : g - f < m && (i = ba(f + m));
        ...
        ab.prototype = {addLabel: function() {
                ...
                this.isFirst = i;
                this.isLast = j;
                b = a.labelFormatter.call({axis: a, chart: c, isFirst: i, isLast: j, dateTimeLabelFormat: l, value: a.isLog ? la(ia(k)) : k});
                f = d && {width: w(1, x(d - 2 * (g.padding || 10))) + "px"};
                f = y(f, g.style);
                if (s(e))
                ...
                var c = this.axis, d = c.options, e = c.chart.renderer, f = c.horiz, g = this.type, h = this.label, i = this.pos, j = d.labels, k = this.gridLine, l = g ? g + "Grid" : "grid", m = g ? g + "Tick" : "tick", o = d[l + "LineWidth"], p = d[l + "LineColor"], t = d[l + "LineDashStyle"], r = d[m + "Length"], l = d[m + "Width"] || 0, q = d[m + "Color"], M = d[m + "Position"], m = this.mark,
                        u = j.step, s = !0, D = c.tickmarkOffset, B = this.getPosition(f, i, D, b), Z = B.x, B = B.y, w = c.staggerLines;
                if (o) {
                    i = c.getPlotLinePath(i + D, o, b);
                    if (k === v) {
                        k = {stroke: p, "stroke-width": o};
                        if (t)
                            k.dashstyle = t;
                        if (!g)
                            k.zIndex = 1;
                ...
                if (l && r)
                    M === "inside" && (r = -r), c.opposite && (r = -r), g = this.getMarkPath(Z, B, r, l, f, e), m ? m.animate({d: g}) : this.mark = e.path(g).attr({stroke: q, "stroke-width": l}).add(c.axisGroup);
                if (h && !isNaN(Z))
                    h.xy = B =
        ...
        Ab.prototype = {render: function() {
                var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = s(j) && s(i), l = e.value, m = e.dashStyle, o = a.svgElem, p =
                        [], t, r = e.color, q = e.zIndex, M = e.events, u = b.chart.renderer;
                b.isLog && (j = qa(j), i = qa(i), l = qa(l));
                if (h) {
                    if (p = b.getPlotLinePath(l, h), d = {stroke: r, "stroke-width": h}, m)
                        d.dashstyle = m
                } else if (k) {
                    if (j = w(j, b.min - d), i = K(i, b.max + d), p = b.getPlotBandPath(j, i, e), d = {fill: r}, e.borderWidth)
                ...
                if (s(q))
                    d.zIndex = q;
                if (o)
                    p ? o.animate({d: p}, null, o.onGetPath) : (o.hide(), o.onGetPath = function() {
                        o.show()
                    });
                ...
                if (f && s(f.text) && p && p.length && b.width > 0 && b.height > 0) {
                    ...
                    if (!g)
                        a.label = g = u.text(f.text, 0, 0).attr({align: f.textAlign || f.align, rotation: f.rotation, zIndex: q}).css(f.style).add();
                    b = [p[1], p[4], n(p[6], p[1])];
                    p = [p[2], p[5], n(p[7], p[2])];
                    c = Ha(b);
                    k = Ha(p);
                    g.align(f, !1, {x: c, y: k, width: sa(b) - c, height: sa(p) - k});
                    g.show()
                } else
                    g && g.hide();
                return a
        ...
        Rb.prototype = {destroy: function() {
                ...
                var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ?
                        100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = U(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
                if (e = this.label)
                    e.align(this.alignOptions, null, f), f = e.alignAttr, e.attr({visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? ja ? "inherit" : "visible" : "hidden"})
            }};
        Ta.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"},
                ...
                tickPixelInterval: 72, showLastLabel: !0, labels: {align: "right", x: -8, y: 3}, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Y-values"}, stackLabels: {enabled: !1, formatter: function() {
                        return this.total
                    }, style: E.style}}, defaultLeftAxisOptions: {labels: {align: "right", x: -8, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {align: "left", x: 8, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {align: "center", x: 0, y: 14}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {align: "center",
                ...
                for (g in d)
                    C(this, g, d[g]);
                if (this.isLog)
                    this.val2lin = qa, this.lin2val = ia
                ...
                var a =
                        this.axis, b = this.value, c = this.dateTimeLabelFormat, d = P.lang.numericSymbols, e = d && d.length, f, g = a.isLog ? b : a.tickInterval;
                if (a.categories)
                    f = b;
                else if (c)
                    f = xa(c, b);
                    ...
                    for (; e-- && f === v; )
                        a = Math.pow(1E3, e + 1), g >= a && d[e] !== null && (f = Qa(b / a, -1) + d[e]);
                ...
                q(a.series, function(g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        var h = g.options,
                                i, j, k, l, m, o, p, t, r, q = h.threshold, M, u = [], x = 0;
                        a.hasVisibleSeries = !0;
                        if (a.isLog && q <= 0)
                            q = h.threshold = null;
                        if (a.isXAxis) {
                            if (h = g.xData, h.length)
                                a.dataMin = K(n(a.dataMin, h[0]), Ha(h)), a.dataMax = w(n(a.dataMax, h[0]), sa(h))
                        } else {
                            var D, B, Z, z = g.cropped, y = g.xAxis.getExtremes(), eb = !!g.modifyValue;
                            i = h.stacking;
                            a.usePercentage = i === "percent";
                            if (i)
                                m = h.stack, l = g.type + n(m, ""), o = "-" + l, g.stackKey = l, j = d[l] || [], d[l] = j, k = e[o] || [], e[o] = k;
                            if (a.usePercentage)
                            ...
                            if (!a.usePercentage && u.length)
                                a.dataMin = K(n(a.dataMin, u[0]), Ha(u)), a.dataMax = w(n(a.dataMax, u[0]), sa(u));
                            if (s(q))
                                if (a.dataMin >= q)
                                    a.dataMin = q, a.ignoreMinPadding =
                                            !0;
                                else if (a.dataMax < q)
                                    a.dataMax = q, a.ignoreMaxPadding = !0
                        }
                    }
                })
                ...
                if (a >= 0.5)
                    ...
                    for (var f = W(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                        i = e.length;
                        for (h = 0; h < i && !l; h++)
                            j = qa(ia(f) * e[h]), j > b && g.push(k), k > c && (l = !0), k = j
                    }
                else if (b = ia(b), c = ia(c), a = e[d ? "minorTickInterval" :
                        "tickInterval"], a = n(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ub(a, null, L.pow(10, W(L.log(a) / L.LN10))), g = Ma(this.getLinearTickPositions(a, b, c), qa), !d)
                ...
                if (this.isLog) {
                    ...
                    d = d.concat(Ya(vb(c), this.min, this.max, a.startOfWeek));
                else
                ...
                if (this.isXAxis)
                    f ? (d = f.minPointOffset, e = f.pointRangePadding) : q(this.series, function(a) {
                ...
                var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval,
                        m = d.minTickInterval, o = d.tickPixelInterval, p = b.categories;
                ...
                if (e)
                    !a && K(b.min, n(b.dataMin, b.min)) <= 0 && Za(10, 1), b.min = la(qa(b.min)), b.max = la(qa(b.max));
                if (b.range && (b.userMin = b.min = w(b.min, b.max - b.range), b.userMax = b.max, a))
                    b.range = null;
                b.adjustForMinRange();
                ...
                if (!l && b.tickInterval < m)
                    b.tickInterval = m;
                if (!f && !e && (a = L.pow(10, W(L.log(b.tickInterval) / L.LN10)), !l))
                    b.tickInterval = ub(b.tickInterval, null, a, d);
                ...
                if (!i)
                    i = f ? (b.getNonLinearTimeTicks || Ya)(vb(b.tickInterval,
                ...
                if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1) {
                    ...
                    if (e < a) {
                        for (; b.length < a; )
                            b.push(la(b[b.length - 1] + this.tickInterval));
                        this.transA *= (e - 1) / (a - 1);
                ...
                var f = this, g = f.chart, c = n(c, !0), e = y(e, {min: a, max: b});
                ...
                var a = this.isLog;
                return{min: a ? la(ia(this.min)) : this.min, max: a ? la(ia(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax}
                ...
                var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i, j = 0, k, l = 0, m = d.title, o = d.labels, p = 0, t = b.axisOffset, r = [-1, 1, 1, -1][h], ga;
                a.hasData = b = a.hasVisibleSeries || s(a.min) && s(a.max) && !!e;
                a.showAxis = i = b || n(d.showEmpty, !0);
                if (!a.axisGroup)
                    a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: o.zIndex ||
                                7}).add();
                if (b || a.isLinked)
                    q(e, function(b) {
                        ...
                        if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === o.align)
                            p = w(f[a].getLabelSize(), p)
                    }), a.staggerLines && (p += (a.staggerLines - 1) * 16);
                else
                    for (ga in f)
                        f[ga].destroy(), delete f[ga];
                if (m && m.text) {
                    if (!a.axisTitle)
                ...
                var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked,
                        g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, o = d.alternateGridColor, p = a.tickmarkOffset, t = d.lineWidth, r, n = b.hasRendered && s(a.oldMin) && !isNaN(a.oldMin), M = a.showAxis, u, w;
                if (a.hasData || f)
                    if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function(b) {
                        ...
                        if (!f ||
                                b >= a.min && b <= a.max)
                            j[b] || (j[b] = new ab(a, b)), n && j[b].isNew && j[b].render(c, !0), j[b].isActive = !0, j[b].render(c)
                    }), o && q(g, function(b, c) {
                        if (c % 2 === 0 && b < a.max)
                            l[b] || (l[b] = new Ab(a)), u = b + p, w = g[c + 1] !== v ? g[c + 1] + p : a.max, l[b].options = {from: e ? ia(u) : u, to: e ? ia(w) : w, color: o}, l[b].render(), l[b].isActive = !0
                    }), !a._addedPlotLB)
                ...
                if (t)
                    r = a.getLinePath(t), a.axisLine ? a.axisLine.animate({d: r}) : a.axisLine = c.path(r).attr({stroke: d.lineColor, "stroke-width": t, zIndex: 7}).add(a.axisGroup), a.axisLine[M ? "show" : "hide"]();
                if (h && M)
        ...
        Bb.prototype = {destroy: function() {
            ...
            move: function(a, b, c, d) {
                ...
                var c, d = this.chart, e = d.inverted, f = 0, g = 0, h, a = ka(a);
                c = a[0].tooltipPos;
                c || (q(a, function(a) {
                    h = a.series.yAxis;
                    f += a.plotX;
                ...
                function c() {
                    var a = this.points || ka(this), b = a[0].series, c;
                ...
                k === !1 || !i ? this.hide() :
                        (this.isHidden && e.show(), e.attr({text: k}), m = f.borderColor || a.color || j.color || "#606060", e.attr({stroke: m}), e = (f.positioner || this.getPosition).call(this, e.width, e.height, {plotX: g, plotY: h}), this.move(x(e.x), x(e.y), g + d.plotLeft, h + d.plotTop), this.isHidden = !1);
                if (o) {
                    o = ka(o);
                    for (e = o.length; e--; )
                        if (i = a.series[e ? "yAxis" : "xAxis"], o[e] && i)
                            if (i = i.getPlotLinePath(e ? n(a.stackY, a.y) : a.x, 1), this.crosshairs[e])
                                ...
                                j = {"stroke-width": o[e].width || 1, stroke: o[e].color ||
                                            "#C0C0C0", zIndex: o[e].zIndex || 2};
                                if (o[e].dashStyle)
                                    j.dashstyle = o[e].dashStyle;
                                this.crosshairs[e] = d.renderer.path(i).attr(j).add()
                            }
                }
                J(d, "tooltipRefresh", {text: k, x: g + d.plotLeft, y: h + d.plotTop, borderColor: m})
            }};
        Cb.prototype = {normalizeMouseEvent: function(a) {
                ...
                return y(a, {chartX: x(c), chartY: x(b)})
                ...
                if (d && this.options.tooltip.shared && (!g ||
                    ...
                    for (i = 0; i < h; i++)
                        if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length)
                            b = c[i].tooltipPoints[k], b._dist = U(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = K(j, b._dist), e.push(b);
                    for (h = e.length; h--; )
                    ...
                    if (b.selectionMarker) {
                        ...
                        e && (q(c.axes, function(a) {
                            if (a.options.zoomEnabled !== !1) {
                                ...
                                !isNaN(e) && !isNaN(d) && (f[b ? "xAxis" : "yAxis"].push({axis: a, min: K(e, d), max: w(e, d)}), m = !0)
                            }
                    ...
                    if (!a || !(a.touches && a.touches.length > 1)) {
                        ...
                        if (c.mouseIsDown && d !== "touchstart" && (e = Math.sqrt(Math.pow(b.mouseDownX - h, 2) + Math.pow(b.mouseDownY - l, 2)), e > 10)) {
                            ...
                            if (b.selectionMarker && f) {
                                ...
                                b.selectionMarker.attr({width: U(o),
                                    x: (o > 0 ? 0 : o) + b.mouseDownX})
                            }
                            b.selectionMarker && g && (l -= b.mouseDownY, b.selectionMarker.attr({height: U(l), y: (l > 0 ? 0 : l) + b.mouseDownY}));
            ...
            destroy: function() {
                ...
                if (b.enabled)
                    a.tooltip = new Bb(a, b);
                this.setDOMEvents()
            }};
        Db.prototype = {init: function(a) {
                var b =
                ...
                if (b)
                    c = b.translateY, q(this.allItems, function(e) {
                        var f = e.checkbox, g;
                        f && (g = c + f.y + (a || 0) + 3, H(f, {left: b.translateX + e.legendItemWidth + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : Y}))
                    })
            }, renderItem: function(a) {
                var B;
                var b = this, c = b.chart,
                        d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, l = !e.rtl, m = e.width, o = e.itemMarginBottom || 0, p = b.itemMarginTop, t = b.initialItemX, r = a.legendItem, n = a.series || a, q = n.options, u = q.showCheckbox, s = e.useHTML;
                if (!r && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), n.drawLegendSymbol(b, a), a.legendItem = r = d.text(e.labelFormatter.call(a), l ? g + h : -h, b.baseline, s).css(z(a.visible ? i : j)).attr({align: l ? "left" : "right",
                    zIndex: 2}).add(a.legendGroup), (s ? r : a.legendGroup).on("mouseover", function() {
                    a.setState("hover");
                ...
                }), b.colorizeItem(a, a.visible), q && u))
                    a.checkbox = X("input", {type: "checkbox", checked: a.selected, defaultChecked: a.selected}, e.itemCheckboxStyle, c.container),
                ...
                if (f && b.itemX - t + e > (m || c.chartWidth - 2 * k - t))
                ...
                if (l || m) {
                    ...
                    if (i) {
                        ...
                        a.box = i = c.rect(0, 0, g, h, j.borderRadius,
                                l || 0).attr({stroke: j.borderColor, "stroke-width": l || 0, fill: m || Y}).add(d).shadow(j.shadow), i.isNew = !0;
                    i[f ? "show" : "hide"]()
                }
                a.legendWidth = g;
                a.legendHeight = h;
                ...
                f && d.align(y({width: g, height: h}, j), !0, b.spacingBox);
                ...
                d > c && (d = c);
                if (d > 0)
                    b !== v && Ia(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7, visibility: "visible"}), this.up.attr({fill: d === 1 ? h : g}).css({cursor: d === 1 ? "default" : "pointer"}), f.attr({text: d + "/" + this.pageCount}), this.down.attr({x: 18 + this.pager.getBBox().width,
        ...
        bb.prototype = {init: function(a, b) {
                ...
                c = z(P, a);
                c.series = a.series = d;
                var d = c.chart, e = d.margin, e = ea(e) ? e : [e, e, e, e];
                ...
                var d, e = this;
                a && (Ia(c, e), b = n(b, !0), J(e, "addSeries", {options: a}, function() {
                    d = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    b && e.redraw()
                }));
                ...
                if (!c)
                    this.loadingDiv = c = X(na, {className: "highcharts-loading"},
                    y(d.style, {left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px", zIndex: 10, display: Y}), this.container), this.loadingSpan = X("span", null, d.labelStyle, c);
                this.loadingSpan.innerHTML = a || b.lang.loading;
                if (!this.loadingShown)
                    H(c, {opacity: 0, display: ""}), Ib(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
                ...
                var a = this, b = this.options, c = b.xAxis || {}, b = b.yAxis || {}, c = ka(c);
                q(c, function(a, b) {
                    a.index = b;
                    a.isX = !0
                });
                ...
                b.series.length && f > K(e.dataMin, e.min) && c < w(e.dataMax, e.max) && b.setExtremes(f, c, !0, !1, {trigger: "pan"});
                this.mouseDownX = a;
                ...
                a ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone) : (c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), H(b, {position: "absolute", top: "-9999px", display: "block"}), I.body.appendChild(b), c && b.appendChild(c))
                ...
                c = this.chartWidth;
                d = this.chartHeight;
                this.container = a = X(na, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, y({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0}, b.style), this.renderToClone || a);
                this.renderer =
                        b.forExport ? new oa(a, c, d, !0) : new Ua(a, c, d);
                aa && this.renderer.create(this, a, c, d)
            }, getMargins: function() {
                var a = this.options.chart, b = a.spacingTop, c = a.spacingRight, d = a.spacingBottom, a = a.spacingLeft, e, f = this.legend, g = this.optionsMarginTop, h = this.optionsMarginLeft, i = this.optionsMarginRight, j = this.optionsMarginBottom, k = this.chartTitleOptions, l = this.chartSubtitleOptions, m = this.options.legend, o = n(m.margin, 10), p = m.x, t = m.y, r = m.align, ga = m.verticalAlign;
                this.resetMargins();
                e = this.axisOffset;
                if ((this.title || this.subtitle) &&
                        !s(this.optionsMarginTop))
                    if (l = w(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0))
                        this.plotTop = w(this.plotTop, l + n(k.margin, 15) + b);
                if (f.display && !m.floating)
                    if (r === "right") {
                        if (!s(i))
                            this.marginRight = w(this.marginRight, f.legendWidth - p + o + c)
                    } else if (r === "left") {
                        if (!s(h))
                            this.plotLeft = w(this.plotLeft, f.legendWidth + p + o + a)
                    } else if (ga === "top") {
                        if (!s(g))
                            this.plotTop = w(this.plotTop, f.legendHeight + t + o + b)
                    } else if (ga === "bottom" && !s(j))
                        this.marginBottom = w(this.marginBottom,
                ...
                function a(a) {
                    var g = c.width || ob(d, "width"), h = c.height || ob(d, "height"), a = a ? a.target : S;
                ...
                if (s(a))
                    d.chartWidth = e = w(0, x(a)), d.hasUserSize = !!e;
                if (s(b))
                    d.chartHeight = f = w(0, x(b));
                ...
                if (k)
                    f ? f.animate(s) : this.plotBackground = b.rect(p, t, n, q, 0).attr({fill: k}).add().shadow(a.plotShadow);
                if (l)
                    h ? h.animate(s) : this.plotBGImage = b.image(l, p, t, n, q).add();
                u ? u.animate({width: w.width, height: w.height}) : this.clipRect = b.clipRect(w);
                if (m)
                    g ? g.animate(g.crisp(null, p, t, n, q)) : this.plotBorder = b.rect(p, t, n, q, 0, m).attr({stroke: a.plotBorderColor,
                ...
                e.items && q(e.items, function(b) {
                    var d = y(e.style, b.style), f = A(d.left) + a.plotLeft, j = A(d.top) + a.plotTop + 12;
                    delete d.left;
                    delete d.top;
        ...
        za.prototype = {init: function(a, b, c) {
                ...
                a.pointCount--;
                if (b && (this.setState(), Ca(b, this), !b.length))
                    a.hoverPoints = null;
                if (this === a.hoverPoint)
                    this.onMouseOut();
                if (this.graphic || this.dataLabel)
                    O(this), this.destroyElements();
                ...
                for (i in d)
                    g = d[i], pa(g) && g !== a && (h = (" " + g).split(e), f = {point: this, series: b}[h[1]], h = h[2], f === this && j.hasOwnProperty(h) ? (f = j[h] ? h : "value", f = (c[f + "Prefix"] || "") + Qa(this[h], n(c[f + "Decimals"], -1)) + (c[f + "Suffix"] || "")) : f = f[h], a = a.replace(g,
                            f));
                return a
                ...
                if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                    if (this.graphic)
                        e = f && this.graphic.symbolName && l[a].r,
                                this.graphic.attr(z(l[a], e ? {x: b - e, y: c - e, width: 2 * e, height: 2 * e} : {}));
                    else {
                        if (a && h)
        ...
        V.prototype = {isCartesian: !0, type: "line", pointClass: za, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, init: function(a, b) {
                var c, d;
                this.chart =
                        a;
                ...
                var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, j = this.xData, k = this.yData, l = g && g.shift || 0, m = e.data, o = this.pointClass.prototype;
                Ia(d, i);
                if (g && c)
                    g.shift = l + 1;
                if (h) {
                ...
                for (m = 0; m < g; m++)
                    i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(ka(e[m]))) : (b[i] ? k = b[i] : a[i] !== v && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
                if (b && (g !== (c = b.length) || j))
                    for (m = 0; m < c; m++)
                        if (m === h && !j && (m += g), b[m])
                            b[m].destroyElements(),
                ...
                for (l = 0; l < h; l++) {
                    var k = g[l], o = k.x, p = k.y, t = k.low, r = f.stacks[(p < b.threshold ? "-" : "") + this.stackKey];
                    k.plotX = d.translate(o, 0, 0, 0, 1, m);
                    if (c && this.visible &&
                            r && r[o])
                        t = r[o], o = t.total, t.cum = t = t.cum - p, p = t + p, j && (t = n(b.threshold, f.min)), f.isLog && t <= 0 && (t = null), c === "percent" && (t = o ? t * 100 / o : 0, p = o ? p * 100 / o : 0), k.percentage = o ? k.y * 100 / o : 0, k.total = k.stackTotal = o, k.stackY = p;
                ...
                if (this.options.enableMouseTracking !== !1) {
                    ...
                    for (h = 0; h < a; h++) {
                        g = b[h];
                        c = b[h - 1] ? d + 1 : 0;
                        for (d = b[h + 1]?w(0, W((g[f] + (b[h + 1]?b[h + 1][f]:e)) / 2)):e; c >= 0 && c <= d; )
                            i[c++] = g
                    }
                ...
                if (e && !ea(e))
                    e = Q[b.type].animation;
                h = "_sharedClip" + e.duration + e.easing;
                if (a)
                    a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(y(f, {width: 0})), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey =
                            h;
                else {
                    if (a = c[h])
                    ...
                    for (f = b.length; f--; )
                        if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === v || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== v && !isNaN(e))
                            if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = n(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                                k.attr({visibility: m ? ja ? "inherit" : "visible" : "hidden"}).animate(y({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                            else {
                                if (m &&
                                        (h > 0 || j))
                ...
                var a = this, b = Q[a.type].marker ? a.options.marker : a.options, c = b.states, d = c.hover, e, f = a.color, g = {stroke: f, fill: f}, h = a.points || [], i = [], j, k = a.pointAttrToOptions, l;
                ...
                for (f = h.length; f--; ) {
                    ...
                    if (e) {
                        ...
                        e = c.hover = c.hover || {};
                        if (!a.options.marker)
                            e.color = ya(e.color || g.color).brighten(e.brightness || d.brightness).get();
                        j[""] = a.convertAttribs(y({color: g.color}, b), i[""]);
                ...
                if (b.enabled || a._hasPointLabels)
                    a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e = b, q(c, function(c) {
                        var i, j = c.dataLabel,
                                k, l = !0;
                ...
                var f = this.chart, g = f.inverted, h = n(a.plotX, -999), a = n(a.plotY, -999), i = b.getBBox(), d = y({x: g ? f.plotWidth - a : h, y: x(g ? f.plotHeight - h : a), width: 0, height: 0}, d);
                ...
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.renderer, h = f.options.tooltip.snap, i = a.tracker, j = b.cursor,
                        j = j && {cursor: j}, k = a.singlePoints, l = this.isCartesian && this.plotGroup("trackerGroup", null, "visible", b.zIndex || 1, f.trackerGroup), m, o = function() {
                    if (f.hoverSeries !== a)
                        a.onMouseOver()
                }, p = function() {
                    if (!b.stickyTracking)
                ...
                if (i)
                    i.attr({d: d});
                else if (a.tracker = i = g.path(d).attr({isTracker: !0,
                    "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: Gb, fill: c ? Gb : Y, "stroke-width": b.lineWidth + (c ? 0 : 2 * h)}).on("mouseover", o).on("mouseout", p).css(j).add(l), wa)
                    i.on("touchstart", o)
            }};
        E = $(V);
        R.line = E;
        Q.area = z(N, {threshold: 0});
        E = $(V, {type: "area", getSegmentPath: function(a) {
                ...
                c ? c.animate({d: a}) : this.area = this.chart.renderer.path(a).attr({fill: n(b.fillColor, ya(this.color).setOpacity(b.fillOpacity || 0.75).get()),
        ...
        R.area = E;
        Q.spline = z(N);
        ca = $(V, {type: "spline", getPointSpline: function(a, b, c) {
        ...
        var Oa = E.prototype, ca = $(ca, {type: "areaspline", closedStacks: !0, getSegmentPath: Oa.getSegmentPath, closeSegment: Oa.closeSegment, drawGraph: Oa.drawGraph});
        R.areaspline = ca;
        Q.column = z(N, {borderColor: "#FFFFFF", borderWidth: 1, borderRadius: 0, groupPadding: 0.2,
        ...
        ca = $(V, {type: "column", tooltipOutsidePlot: !0, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, init: function() {
                ...
                c.grouping === !1 ? f = 1 : q(b.series, function(b) {
                    ...
                    if (b.type === a.type && b.visible && a.options.group === c.group)
                        c.stacking ? (k = b.stackKey, j[k] === v && (j[k] = f++), l = j[k]) : c.grouping !== !1 && (l = f++), b.columnIndex = l
                });
                var m = a.points, g = U(g.transA) * (g.ordinalSlope || c.pointRange || g.closestPointRange || 1), o = g * c.groupPadding, p =
                        (g - 2 * o) / f, t = c.pointWidth, r = s(t) ? (p - t) / 2 : p * c.pointPadding, x = n(t, p - 2 * r), M = Ka(w(x, 1 + 2 * e)), u = r + (o + ((i ? f - (a.columnIndex || 0) : a.columnIndex) || 0) * p - g / 2) * (i ? -1 : 1), y = a.translatedThreshold = h.getThreshold(c.threshold), D = n(c.minPointLength, 5);
                q(m, function(c) {
                    var f = K(w(-999, c.plotY), h.len + 999), g = n(c.yBottom, y), i = c.plotX + u, j = Ka(K(f, g)), k = Ka(w(f, g) - j), l = h.stacks[(c.y < 0 ? "-" : "") + a.stackKey];
                    ...
                    c.trackerArgs = U(k) < 3 && z(c.shapeArgs, {height: 6, y: j - 3})
                })
            }, getSymbol: db, drawLegendSymbol: E.prototype.drawLegendSymbol, drawGraph: db, drawPoints: function() {
                var a = this, b = a.options, c = a.chart.renderer, d;
                q(a.points, function(e) {
                    var f = e.plotY, g = e.graphic;
                    if (f !== v && !isNaN(f) && e.y !== null)
                        d = e.shapeArgs, g ? (pb(g), g.animate(z(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow,
                                null, b.stacking && !b.borderRadius);
                    else if (g)
                        e.graphic = g.destroy()
                })
            }, drawTracker: function() {
                for (var a = this, b = a.chart, c = b.renderer, d, e, f = +new Date, g = a.options, h = (d = g.cursor) && {cursor: d}, i = a.isCartesian && a.plotGroup("trackerGroup", null, "visible", g.zIndex || 1, b.trackerGroup), j, k, l = a.points, m, o = l.length, p = function(c) {
                    j = c.relatedTarget || c.fromElement;
                    if (b.hoverSeries !== a && F(j, "isTracker") !== f)
                        a.onMouseOver();
                    ...
                    if (m = l[o], e = m.tracker, d = m.trackerArgs || m.shapeArgs, k = m.plotY, k = !a.isCartesian || k !== v && !isNaN(k), delete d.strokeWidth, m.y !== null && k) {
                        if (e)
                            e.attr(d);
                        else if (m.tracker = e = c[m.shapeType](d).attr({isTracker: f, fill: Gb, visibility: a.visible ? "visible" : "hidden"}).on("mouseover", p).on("mouseout", n).css(h).add(m.group || i), wa)
                            e.on("touchstart", p);
                        e.element._i = o
                    }
            }, alignDataLabel: function(a, b, c, d, e) {
                ...
                if (a.shapeArgs && (d = z(a.shapeArgs), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width}), !i))
        ...
        R.column = ca;
        Q.bar = z(Q.column);
        Oa = $(ca, {type: "bar", inverted: !0});
        R.bar = Oa;
        Q.scatter = z(N, {lineWidth: 0, states: {hover: {lineWidth: 0}}, tooltip: {headerFormat: '<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>',
        ...
        Oa = $(V, {type: "scatter", sorted: !1, requireSorting: !1, translate: function() {
                ...
                if (a._hasTracking)
                    a._hasTracking = !0;
                else if (f.attr({isTracker: !0}).on("mouseover", g).on("mouseout", function() {
        ...
        R.scatter = Oa;
        Q.pie = z(N, {borderColor: "#FFFFFF", borderWidth: 1, center: ["50%", "50%"], colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function() {
                    return this.point.name
                }}, legendType: "point", marker: null, size: "75%", showInLegend: !1, slicedOffset: 10, states: {hover: {brightness: 0.1, shadow: !1}}});
        N = {type: "pie", isCartesian: !1, pointClass: $(za, {init: function() {
                    za.prototype.init.apply(this, arguments);
                    var a = this, b;
                    y(a, {visible: a.visible !== !1, name: n(a.name, "Slice")});
                    b = function() {
                        a.slice()
                    };
                    C(a, "select", b);
                ...
                this.generatePoints();
                var a = 0, b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g = this.chart, h, i, j, k = this.startAngleRad = La / 180 * ((c.startAngle || 0) % 360 - 90), l = this.points, m = 2 * La, o = c.dataLabels.distance, p = c.ignoreHiddenPoint, n, q = l.length, s;
            ...
            render: function() {
                ...
                q(a.points, function(j) {
                    ...
                    e ? e.animate(i) : j.graphic = e = c.arc(i).setRadialReference(a.center).attr(y(j.pointAttr[""], {"stroke-linejoin": "round"})).add(j.group).shadow(g, h);
                    j.visible === !1 && j.setVisible(!1)
                })
            }, drawDataLabels: function() {
                var a = this.data, b, c = this.chart, d = this.options.dataLabels, e = n(d.connectorPadding, 10), f = n(d.connectorWidth, 1), g, h, i = n(d.softConnector, !0), j = d.distance, k = this.center, l = k[2] / 2, m = k[1], o = j > 0, p = [[], []], t, r, s, w = 2, u, x = function(a, b) {
                    return b.y -
                            a.y
                }, D = function(a, b) {
                    a.sort(function(a, c) {
                ...
                if (d.enabled || this._hasPointLabels) {
                    ...
                    for (a = p[0][0] && p[0][0].dataLabel && (p[0][0].dataLabel.getBBox().height || 21); w--; ) {
                        var B = [], v = [], z = p[w], y = z.length, A;
                        D(z, w - 0.5);
                        if (j > 0) {
                            for (u = m - l - j; u <= m + l + j; u += a)
                                B.push(u);
                            s = B.length;
                            if (y > s) {
                                h = [].concat(z);
                            ...
                            for (u = 0; u < y; u++) {
                                ...
                                b = 9999;
                                for (r = 0; r < s; r++)
                                    g = U(B[r] - h[1]), g < b && (b = g, A = r);
                                if (A < u && B[u] !== null)
                                    A = u;
                                else
                                    for (s < y - u + A && B[u] !== null && (A = s - y + u); B[A] === null; )
                                        A++;
                                v.push({i: A, y: B[A]});
                                B[A] = null
                            }
                        ...
                        for (u = 0; u < y; u++) {
                            ...
                            t = h[1];
                            if (j > 0) {
                                if (r = v.pop(), A = r.i, r = r.y, t > r && B[A + 1] !== null || t < r && B[A - 1] !== null)
                                    r = t
                            } else
                                r = t;
                            t = d.justify ? k[0] + (w ? -1 : 1) * (l + j) : this.getX(A === 0 || A === B.length - 1 ? t : r, w);
                            g.attr({visibility: s, align: h[6]})[g.moved ? "animate" : "attr"]({x: t +
                                        d.x + ({left: e, right: -e}[h[6]] || 0), y: r + d.y - 10});
                            g.moved = !0;
                            if (o && f)
                                g = b.connector, h = i ? ["M", t + (h[6] === "left" ? 5 : -5), r, "C", t, r, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", t + (h[6] === "left" ? 5 : -5), r, "L", h[2], h[3], "L", h[4], h[5]], g ? (g.animate({d: h}), g.attr("visibility", s)) : b.connector = g = this.chart.renderer.path(h).attr({"stroke-width": f, stroke: d.connectorColor || b.color || "#606060", visibility: s, zIndex: 3}).translate(c.plotLeft, c.plotTop).add()
                        }
                    }
                }
            }, alignDataLabel: db, drawTracker: ca.prototype.drawTracker,
            drawLegendSymbol: E.prototype.drawLegendSymbol, getSymbol: function() {
            }};
        N = $(V, N);
        R.pie = N;
        var T = V.prototype, fc = T.processData, gc = T.generatePoints, hc = T.destroy, ic = T.tooltipHeaderFormatter, jc = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: ha(fb, ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], Xa, ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], Ra, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], ra, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], da, ["%A, %b %e, %Y",
            ...
            [Xa, [1, 2, 5, 10, 15, 30]], [Ra, [1, 2, 5, 10, 15, 30]], [ra, [1, 2, 3, 4, 6, 8, 12]], [da, [1]], [Ea, [1]], [Fa, [1, 3, 6]], [ma, null]], Aa = {sum: function(a) {
                var b = a.length, c;
                if (!b && a.hasNulls)
                    c = null;
                else if (b)
        ...
        T.groupData = function(a, b, c, d) {
            var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Aa[d], o = this.pointArrayMap, p = o && o.length, n;
            for (n =
                    0; n <= i; n++) {
                for (; c[1] !== v && a[n] >= c[1] || n === i; )
                    if (j = c.shift(), k = d.apply(0, m), k !== v && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i)
                        break;
                if (n === i)
                    break;
                if (o) {
        ...
        T.processData = function() {
            var a =
                    this.chart, b = this.options, c = b.dataGrouping, d = c && n(c.enabled, a.options._stock), e;
            this.forceCrop = d;
            if (fc.apply(this, arguments) !== !1 && d) {
                this.destroyGroupedData();
                var d = this.processedXData, f = this.processedYData, g = a.plotSizeX, h = this.xAxis, i = n(h.groupPixelWidth, c.groupPixelWidth), j = d.length, k = a.series, l = this.pointRange;
                if (!h.groupPixelWidth) {
                    for (a = k.length; a--; )
                        k[a].xAxis === h && k[a].options.dataGrouping && (i = w(i, k[a].options.dataGrouping.groupPixelWidth));
                    h.groupPixelWidth = i
                }
                if (j > g / i || j && c.forced) {
                    e = !0;
                    ...
                    this.currentDataGrouping = null, this.pointRange = l;
        ...
        Q.ohlc = z(Q.column, {lineWidth: 1, tooltip: {pointFormat: '<span style="color:{series.color};font-weight:bold">{series.name}</span><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'}, states: {hover: {lineWidth: 3}}, threshold: null});
        N = $(za,
                {applyOptions: function(a) {
                        var b = this.series, c = b.pointArrayMap, d = 0, e = 0, f = c.length;
                        if (typeof a === "object" && typeof a.length !== "number")
                            y(this, a), this.options = a;
                        else if (a.length) {
                            if (a.length > f) {
                        ...
                        return['<span style="color:' + a.color + ';font-weight:bold">', this.name ||
                                    a.name, "</span><br/>Open: ", this.open, "<br/>High: ", this.high, "<br/>Low: ", this.low, "<br/>Close: ", this.close, "<br/>"].join("")
                    }, toYData: function() {
                        return[this.open, this.high, this.low, this.close]
                    }});
        N = $(R.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], pointValKey: "high", pointClass: N, pointAttrToOptions: {stroke: "color", "stroke-width": "lineWidth"}, upColorProp: "stroke", getAttribs: function() {
                R.column.prototype.getAttribs.apply(this, arguments);
                var a = this.options, b = a.states, c = a.upColor ||
                        this.color, a = z(this.pointAttr), d = this.upColorProp, e = this.points || [], f = e.length;
                a[""][d] = c;
                ...
                q(a.points, function(k) {
                    if (k.plotY !== v)
                        i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, j = x(k.plotX) + f, g = x(k.shapeArgs.width / 2), h = ["M", j, x(k.yBottom), "L", j, x(k.plotY)], k.open !== null && (d = x(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = x(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.animate({d: h}) : k.graphic = b.renderer.path(h).attr(c).add(a.group)
                })
            }, animate: null});
        R.ohlc = N;
        Q.candlestick = z(Q.column, {lineColor: "black", lineWidth: 1, states: {hover: {lineWidth: 2}},
            tooltip: Q.ohlc.tooltip, threshold: null, upColor: "white"});
        N = $(N, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "lineColor", "stroke-width": "lineWidth"}, upColorProp: "fill", drawPoints: function() {
                var a = this, b = a.chart, c, d, e, f, g, h, i, j, k, l;
                q(a.points, function(m) {
                    j = m.graphic;
                    if (m.plotY !== v)
                        c = m.pointAttr[m.selected ? "selected" : ""], h = c["stroke-width"] % 2 / 2, i = x(m.plotX) + h, d = x(m.plotOpen) + h, e = x(m.plotClose) + h, f = L.min(d, e), g = L.max(d, e), l = x(m.shapeArgs.width / 2), k = ["M", i - l, g, "L", i - l, f, "L", i + l, f, "L", i + l,
                            g, "L", i - l, g, "M", i, g, "L", i, x(m.yBottom), "M", i, f, "L", i, x(m.plotY), "Z"], j ? j.animate({d: k}) : m.graphic = b.renderer.path(k).attr(c).add(a.group)
                })
            }});
        R.candlestick = N;
        var sb = oa.prototype.symbols;
        Q.flags = z(Q.column, {dataGrouping: null, fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 7, states: {hover: {lineColor: "black", fillColor: "#FCFFC5"}}, style: {fontSize: "11px", fontWeight: "bold", textAlign: "center"}, threshold: null, y: -30});
        R.flags = $(R.column, {type: "flags", sorted: !1, noSharedTooltip: !0, takeOrdinalPosition: !1,
            forceCrop: !0, init: V.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function() {
                ...
                for (k = b.length; k--; )
                    if (l = b[k], d = l.plotX + m, j = l.stackIndex,
                            e = l.plotY, e !== v && (e = l.plotY + g + m - (j !== v && j * f.stackDistance)), i = j ? v : l.plotX + m, o = j ? v : l.plotY, j = l.graphic, a = l.tracker, e !== v)
                        a = l.pointAttr[l.selected ? "select" : ""], j ? j.attr({x: d, y: e, r: a.r, anchorX: i, anchorY: o}) : j = l.graphic = c.label(l.options.title || f.title || "A", d, e, h, i, o).css(z(f.style, l.style)).attr(a).attr({align: h === "flag" ? "left" : "center", width: f.width, height: f.height}).add(this.group).shadow(f.shadow), i = j.box, j = i.getBBox(), l.shapeArgs = y(j, {x: d - (h === "flag" ? 0 : i.attr("width") / 2), y: e});
                    else if (j)
                        l.graphic =
        ...
        N = ha("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [[0, "#FFF"], [1, "#CCC"]]);
        E = [].concat(ac);
        E[4] = [da, [1, 2, 3, 4]];
        E[5] = [Ea, [1, 2, 3]];
        y(P, {navigator: {handles: {backgroundColor: "#FFF", borderColor: "#666"}, height: 40, margin: 10, maskFill: "rgba(255, 255, 255, 0.75)", outlineColor: "#444", outlineWidth: 1, series: {type: "areaspline", color: "#4572A7", compare: null, fillOpacity: 0.4,
                ...
                barBorderWidth: 1, barBorderColor: "#666", buttonArrowColor: "#666", buttonBackgroundColor: N, buttonBorderColor: "#666", buttonBorderRadius: 2, buttonBorderWidth: 1, minWidth: 6, rifleColor: "#666", trackBackgroundColor: ha("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [[0, "#EEE"], [1, "#FFF"]]), trackBorderColor: "#CCC", trackBorderWidth: 1}});
        Sb.prototype = {getAxisTop: function(a) {
                ...
                var c =
                        this.chart.renderer, d = this.elementsToDestroy, e = this.handles, f = this.navigatorOptions.handles, f = {fill: f.backgroundColor, stroke: f.borderColor, "stroke-width": 1}, g;
                this.rendered || (e[b] = c.g().css({cursor: "e-resize"}).attr({zIndex: 4 - b}).add(), g = c.rect(-4.5, 0, 9, 16, 3, 1).attr(f).add(e[b]), d.push(g), g = c.path(["M", -1.5, 4, "L", -1.5, 12, "M", 0.5, 4, "L", 0.5, 12]).attr(f).add(e[b]), d.push(g));
                e[b].translate(this.scrollerLeft + this.scrollbarHeight + parseInt(a, 10), this.top + this.height / 2 - 8)
            }, drawScrollbarButton: function(a) {
                var b =
                        this.chart.renderer, c = this.elementsToDestroy, d = this.scrollbarButtons, e = this.scrollbarHeight, f = this.scrollbarOptions, g;
                ...
                a && d[a].attr({translateX: this.scrollerWidth -
                            e})
            }, render: function(a, b, c, d) {
                var e = this.chart, f = e.renderer, g, h, i, j, k = this.scrollbarGroup, l = this.scrollbar, m = this.xAxis, o = this.scrollbarTrack, p = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions, s = this.scrollbarOptions, v = s.minWidth, u = this.height, z = this.top, D = this.navigatorEnabled, B = r.outlineWidth, y = B / 2, C = 0, F = this.outlineHeight, I = s.barBorderRadius, G = s.barBorderWidth, E = z + y;
                if (!isNaN(a)) {
                    ...
                    if (m.getExtremes) {
                        var H = e.xAxis[0].getExtremes(), e = H.dataMin === null, J = m.getExtremes(), L = K(H.dataMin, J.dataMin), H = w(H.dataMax, J.dataMax);
                    ...
                    if (!this.rendered) {
                        if (D)
                            this.leftShade = f.rect().attr({fill: r.maskFill, zIndex: 3}).add(), this.rightShade =
                                    f.rect().attr({fill: r.maskFill, zIndex: 3}).add(), this.outline = f.path().attr({"stroke-width": B, stroke: r.outlineColor, zIndex: 3}).add();
                        if (q)
                            this.scrollbarGroup = k = f.g().add(), l = s.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({y: -l % 2 / 2, fill: s.trackBackgroundColor, stroke: s.trackBorderColor, "stroke-width": l, r: s.trackBorderRadius || 0, height: p}).add(k), this.scrollbar = l = f.rect().attr({y: -G % 2 / 2, height: p, fill: s.barBackgroundColor, stroke: s.barBorderColor, "stroke-width": G, r: I}).add(k), this.scrollbarRifles =
                                    f.path().attr({stroke: s.rifleColor, "stroke-width": 1}).add(k)
                    }
                    D && (this.leftShade.attr({x: g, y: z, width: d, height: u}), this.rightShade.attr({x: g + a, y: z, width: h - a, height: u}), this.outline.attr({d: ["M", i, E, "L", g + d + y, E, g + d + y, E + F - p, "M", g + a - y, E + F - p, "L", g + a - y, E, i + j, E]}), this.drawHandle(d + y, 0), this.drawHandle(a + y, 1));
                    q && (this.drawScrollbarButton(0), this.drawScrollbarButton(1), k.translate(i, x(E + u)), o.attr({width: j}), f = p + d, g = c - G, g < v && (C = (v - g) / 2, g = v, f -= C), l.attr({x: W(f) + G % 2 / 2, width: g}), v = p + d + c / 2 - 0.5, this.scrollbarRifles.attr({d: ["M",
                            v - 3, p / 4, "L", v - 3, 2 * p / 3, "M", v, p / 4, "L", v, 2 * p / 3, "M", v + 3, p / 4, "L", v + 3, 2 * p / 3], visibility: c > 12 ? "visible" : "hidden"}));
                    this.scrollbarPad = C;
                    this.rendered = !0
                }
            }, addEvents: function() {
                ...
                var a = this, b = a.chart, c, d, e = a.scrollbarHeight, f = a.navigatorOptions, g = a.height, h = a.top, i, j, k, l = document.body.style, m, o = a.baseSeries, p;
                a.mouseDownHandler = function(d) {
                    var d = b.tracker.normalizeMouseEvent(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, i = a.scrollbarHeight, k = a.scrollerLeft, o = a.scrollerWidth, p = a.navigatorLeft, n = a.navigatorWidth, q = a.scrollbarPad, r = a.range, t = d.chartX, s = d.chartY, u = b.xAxis[0],
                            v = nb ? 10 : 7;
                    if (s > h && s < h + g + i)
                        if ((h = !a.scrollbarEnabled || s < h + g) && L.abs(t - e - p) < v)
                            a.grabbedLeft = !0, a.otherHandlePos = f;
                        else if (h && L.abs(t - f - p) < v)
                            a.grabbedRight = !0, a.otherHandlePos = e;
                        else if (t > p + e - q && t < p + f + q) {
                            a.grabbedCenter = t;
                            if (b.renderer.isSVG)
                                m = l.cursor, l.cursor = "ew-resize";
                            j = t - e
                        } else if (t > k && t < k + o && (f = h ? t - p - r / 2 : t < p ? e - K(10, r) : t > k + o - i ? e + K(10, r) : t < p + e ? e - r : f, f < 0 ? f = 0 : f + r > n && (f = n - r), f !== e)) {
                            a.fixedWidth = r;
                            if (!u.ordinalPositions)
                                u.fixedRange = u.max - u.min;
                            e = c.translate(f, !0);
                            u.setExtremes(e, u.fixedRange ? e + u.fixedRange :
                                    c.translate(f + r, !0), !0, !1, {trigger: "navigator"})
                        }
                ...
                a.mouseMoveHandler = function(c) {
                    ...
                    if (c.pageX !== 0)
                        c = b.tracker.normalizeMouseEvent(c), c = c.chartX, c < e ? c = e : c > g + h - d && (c = g + h - d), a.grabbedLeft ? (k = !0, a.render(0, 0, c - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, a.render(0, 0, a.otherHandlePos, c - e)) : a.grabbedCenter && (k = !0, c < j ? c = j : c > f + j - i && (c = f + j - i), a.render(0, 0, c - j, c - j +
                                i))
                };
                a.mouseUpHandler = function() {
                    var d = a.zoomedMin, e = a.zoomedMax;
                    k && b.xAxis[0].setExtremes(c.translate(d, !0), c.translate(e, !0), !0, !1, {trigger: "navigator"});
                    a.grabbedLeft = a.grabbedRight = a.grabbedCenter = k = j = null;
                    l.cursor = m || ""
                };
                a.updatedDataHandler = function() {
                    var c = o.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, j, k, l, m, n;
                    j = i.xData;
                    var q = !!c.setExtremes;
                    k = f >= j[j.length - 1];
                    j = e <= g;
                    if (!p)
                        i.options.pointStart = o.xData[0], i.setData(o.options.data, !1), n = !0;
                    j && (m = g, l = m + h);
                    k && (l = d, j ||
                            (m = w(l - h, i.xData[0])));
                    q && (j || k) ? c.setExtremes(m, l, !0, !1, {trigger: "updatedData"}) : (n && b.redraw(!1), a.render(w(e, g), K(f, d)))
                };
                var n = b.xAxis.length, q = b.yAxis.length, s = b.setSize;
                b.extraBottomMargin = a.outlineHeight + f.margin;
                a.top = h = a.getAxisTop(b.chartHeight);
                if (a.navigatorEnabled) {
                    var v = o ? o.options : {}, u = v.data, x = f.series;
                    p = x.data;
                    v.data = x.data = null;
                    a.xAxis = c = new Ta(b, z({ordinal: o && o.xAxis.options.ordinal}, f.xAxis, {isX: !0, type: "datetime", index: n, height: g, top: h, offset: 0, offsetLeft: e, offsetRight: -e, startOnTick: !1,
                        endOnTick: !1, minPadding: 0, maxPadding: 0, zoomEnabled: !1}));
                    a.yAxis = d = new Ta(b, z(f.yAxis, {alignTicks: !1, height: g, top: h, offset: 0, index: q, zoomEnabled: !1}));
                    n = z(v, x, {threshold: null, clip: !1, enableMouseTracking: !1, group: "nav", padXAxis: !1, xAxis: n, yAxis: q, name: "Navigator", showInLegend: !1, isInternal: !0, visible: !0});
                    v.data = u;
                    x.data = p;
                    n.data = p || u;
                    i = b.initSeries(n);
                    ...
                    a.xAxis = c = {translate: function(a, c) {
                            var d = b.xAxis[0].getExtremes(), f = b.plotWidth -
                                    2 * e, g = d.dataMin, d = d.dataMax - g;
        ...
        y(P, {rangeSelector: {buttonTheme: {width: 28, height: 16, padding: 1, r: 0, zIndex: 7}, inputPosition: {align: "right"}, labelStyle: {color: "#666"}}});
        P.lang = z(P.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
        Tb.prototype = {clickButton: function(a, b, c) {
                var d = this, e = d.chart, f = d.buttons, g = e.xAxis[0], h = g && g.getExtremes(), i = e.scroller && e.scroller.xAxis, j = i && i.getExtremes && i.getExtremes(), i = j && j.dataMin, j = j && j.dataMax, k = h && h.dataMin, l = h && h.dataMax, i = (s(k) &&
                        s(i) ? K : n)(k, i), j = (s(l) && s(j) ? w : n)(l, j), m, o = g && K(h.max, j), h = new Date(o), l = b.type, k = b.count, p, q, r = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5};
                if (!(i === null || j === null || a === d.selected))
                    r[l] ? (p = r[l] * k, m = w(o - p, i)) : l === "month" ? (h.setMonth(h.getMonth() - k), m = w(h.getTime(), i), p = 2592E6 * k) : l === "ytd" ? (h = new Date(j), q = h.getFullYear(), m = q = w(i || 0, Date.UTC(q, 0, 1)), h = h.getTime(), o = K(j || h, h)) : l === "year" ? (h.setFullYear(h.getFullYear() - k), m = w(i, h.getTime()), p = 31536E6 * k) : l === "all" && g && (m = i, o =
                            j), f[a] && f[a].setState(2), g ? setTimeout(function() {
                        g.setExtremes(m, o, n(c, 1), 0, {trigger: "rangeSelectorButton", rangeSelectorButton: b});
                        d.selected = a
                    }, 1) : (e = e.options.xAxis, e[0] = z(e[0], {range: p, min: q}), d.selected = a)
                ...
                var b = this, c = a.options.rangeSelector, d = c.buttons || [].concat(b.defaultButtons),
                        e = b.buttons = [], c = c.selected, f = b.blurInputs = function() {
                ...
                this[a + "Label"] = j = e.label(P.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 1}).css(z(d, f.labelStyle)).add(l);
                l.offset +=
                        j.width + 5;
                this[a + "DateBox"] = k = e.label("", l.offset).attr({padding: 1, width: 90, height: 16, stroke: "silver", "stroke-width": 1}).css(z({textAlign: "center"}, d, f.inputStyle)).on("click", function() {
                    b[a + "Input"].focus()
                }).add(l);
                l.offset += k.width + (h ? 10 : 0);
                this[a + "Input"] = i = X("input", {name: a, className: "highcharts-range-selector", type: "text"}, y({position: "absolute", border: "2px solid silver", top: "-9999em", textAlign: "center", fontSize: d.fontSize, fontFamily: d.fontFamily}, f.inputStyle), g);
                i.onfocus = function() {
                    H(this,
                            {left: l.translateX + k.x + "px", top: l.translateY + "px", width: k.width - 2 + "px", height: k.height - 2 + "px"})
                };
                i.onblur = function() {
                    H(this, {top: "-9999em"});
                    b.setInputValue(a)
                ...
                i.onchange = function() {
                    ...
                    if (!isNaN(d) && (h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >= b.minInput.HCTime))
                        c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, v, v, {trigger: "rangeSelectorInput"})
                }
            }, render: function(a, b) {
                var c =
                        this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && d.options.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, k = P.lang, l = c.div, l = c.inputGroup, m = i.buttonTheme, o = i.inputEnabled !== !1, n = m && m.states, t = d.plotLeft, r;
                if (!c.rendered && (c.zoomText = e.text(k.rangeSelectorZoom, t, d.plotTop - 10).css(i.labelStyle).add(), r = t + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function(a, b) {
                    j[b] = e.button(a.text, r, d.plotTop - 25, function() {
                        c.clickButton(b, a);
                        c.isActive = !0
                    }, m, n && n.hover, n && n.select).css({textAlign: "center"}).add();
                    r += j[b].width + (i.buttonSpacing || 0);
                    c.selected === b && j[b].setState(2)
                }), o))
                    c.div = l = X("div", null, {position: "relative", height: 0, zIndex: 1}), f.parentNode.insertBefore(l, f), c.inputGroup = l = e.g("input-group").add(), l.offset = 0, c.drawInput("min"), c.drawInput("max");
                o && (f = d.plotTop - 35, l.align(y({y: f, width: l.offset, x: h && f < h.y + h.height - g.chart.spacingTop ? -60 : 0}, i.inputPosition), !0, d.spacingBox), c.setInputValue("min", a), c.setInputValue("max", b));
                c.rendered = !0
            }, destroy: function() {
        ...
        Highcharts.StockChart = function(a, b) {
            var c = a.series, d, e = {marker: {enabled: !1, states: {hover: {radius: 5}}}, shadow: !1, states: {hover: {lineWidth: 2}}},
            ...
            a.series = null;
            a = z({chart: {panning: !0}, navigator: {enabled: !0}, scrollbar: {enabled: !0}, rangeSelector: {enabled: !0}, title: {text: null}, tooltip: {shared: !0,
                    crosshairs: !0}, legend: {enabled: !1}, plotOptions: {line: e, spline: e, area: e, areaspline: e, arearange: e, areasplinerange: e, column: f, columnrange: f, candlestick: f, ohlc: f}}, a, {_stock: !0, chart: {inverted: !1}});
            a.series = c;
            return new bb(a, b)
        };
        var kc = T.init, lc = T.processData, mc = za.prototype.tooltipFormatter;
        T.init = function() {
        ...
        (function() {
                ...
                if (d && d.options.ordinal && !d.hasOrdinalExtension) {
                    ...
                    d.lin2val = function(a,
                        ...
                        if (c) {
                            ...
                            if (b)
                                a < 0 ? a = c[0] : a > k ? a = c[k] : (k = W(a), m = a - k);
                            else
                                for (; k--; )
                                    if (l = d * k + e, a >= l) {
                                        d = d * (k + 1) + e;
                    ...
                    d.getExtendedPositions = function() {
                        ...
                        if (!e[h])
                            j = {series: [], getExtremes: function() {
                                    return{min: i.dataMin,
                                        max: i.dataMax}
                                }, options: {ordinal: !0}}, q(d.series, function(d) {
                                k = {xAxis: j, xData: d.xData, chart: b, destroyGroupedData: db};
                    ...
                    d.getNonLinearTimeTicks = function(a, b, c, e, j, k, l) {
                        var m = 0, o = 0, n, q = {}, r, w, x, u = [], z = d.options.tickPixelInterval;
                        if (!j || b === v)
                            return Ya(a, b, c, e);
                        for (w = j.length; o < w; o++) {
                            x = o && j[o - 1] > c;
                            j[o] < b && (m = o);
                            if (o === w - 1 || j[o + 1] - j[o] > k * 5 || x)
                                n = Ya(a, j[m], j[o], e), u = u.concat(n), m = o + 1;
                            if (x)
                                break
                        }
                        a = n.info;
                        if (l && a.unitRange <= G[ra]) {
                            o = u.length - 1;
                            for (m = 1; m < o; m++)
                                (new Date(u[m]))[Ga]() !== (new Date(u[m - 1]))[Ga]() && (q[u[m]] =
                                        da, r = !0);
                            r && (q[u[0]] = da);
                            a.higherRanks = q
                        }
                        u.info = a;
                        if (l && s(z)) {
                            var l = a = u.length, o = [], y;
                            for (r = []; l--; )
                                m = d.translate(u[l]), y && (r[l] = y - m), o[l] = y = m;
                            r.sort();
                            r = r[W(r.length / 2)];
                            r < z * 0.6 && (r = null);
                            l = u[a - 1] > c ? a - 1 : a;
                            for (y = void 0; l--; )
                                m = o[l], c = y - m, y && c < z * 0.8 && (r === null || c < r * 0.8) ? (q[u[l]] && !q[u[l + 1]] ? (c = l + 1, y = m) : c = l, u.splice(c, 1)) : y = m
                        }
                        return u
                    };
                    var e = b.pan;
                    b.pan = function(a) {
                        ...
                        if (d.options.ordinal && d.series.length) {
                            ...
                            o = b.hoverPoints;
                            var n = d.closestPointRange, i = (i - a) / (d.translationSlope * (d.ordinalSlope || n)), t = {ordinalPositions: d.getExtendedPositions()}, r, n = d.lin2val, s = d.val2lin;
                            if (t.ordinalPositions) {
                                if (U(i) > 1)
                                    o && q(o, function(a) {
                                        a.setState()
                                    }), i < 0 ? (o = t, t = d.ordinalPositions ? d : t) : o = d.ordinalPositions ? d : t, r = t.ordinalPositions, k > r[r.length - 1] && r.push(k), o = n.apply(o, [s.apply(o, [l, !0]) + i, !0]), i = n.apply(t, [s.apply(t, [m, !0]) + i, !0]), o > K(j.dataMin, l) && i < w(k, m) && d.setExtremes(o, i, !0, !1, {trigger: "pan"}), b.mouseDownX = a, H(b.container, {cursor: "move"})
                            } else
                                h =
                                        !0
                        } else
            ...
            T.getSegments = function() {
                ...
                b.apply(a);
                if (e)
                    d = a.segments, q(d, function(b, g) {
                        for (var h = b.length - 1; h--; )
                            b[h + 1].x - b[h].x > a.xAxis.closestPointRange * e && d.splice(g + 1, 0, b.splice(h + 1, b.length - h))
                    })
            }
        })();
        y(Highcharts, {Axis: Ta, CanVGRenderer: rb, Chart: bb, Color: ya, Legend: Db, MouseTracker: Cb, Point: za, Tick: ab, Tooltip: Bb, Renderer: Ua, Series: V, SVGRenderer: oa, VMLRenderer: Na, arrayMin: Ha, arrayMax: sa, charts: Va, dateFormat: xa, pathAnim: Fb, getOptions: function() {
                return P
            },
            hasBidiBug: bc, isTouchDevice: nb, numberFormat: Qa, seriesTypes: R, setOptions: function(a) {
                P = z(P, a);
                Qb();
                return P
            }, addEvent: C, removeEvent: O, createElement: X, discardElement: Sa, css: H, each: q, extend: y, map: Ma, merge: z, pick: n, splat: ka, extendClass: $, pInt: A, wrap: tb, svg: ja, canvas: aa, vml: !ja && !aa, product: "Highstock", version: "1.2.5"})
    })();
