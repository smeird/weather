<?php
 ...
 switch ($scale) {
    ...
    break;
    case "week":
     $scalesql = "WHERE FROM_UNIXTIME(dateTime) > (NOW() - INTERVAL 2 WEEK) ";
...
//<script src=\"https://code.highcharts.com/modules/series-label.js\"></script>";
    ...
    echo "  <div class=\"container-fluid\"><div class=\"card-header\">Min Max</div>
...
Highcharts.chart('container', {
  chart: {
    ...
    title: {
        text: ' Max, Min & Avg for $what in the Last $scale'
    },
...
function standardgraph($gt, $what, $graphdata, $gscale, $scale)
{
    ...
    <div class=\"container-fluid\">
      <div class=\"card mt-3 bg-light shadow  \"><div class=\"card-header\">$what: $scale</div><div class=\"card-body\">
