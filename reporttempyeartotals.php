...
echo "<div class=\"container\"><br>  <div class=\"card shadow\">
	<div class=card-header>Monthly Outside Temperature Comparison (°C)</div>
            <div class=\"card-body\">
";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    } elseif ($min_temp == $min_tps_per_month[$month]) {
