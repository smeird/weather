...
- Static assets like CSS and JavaScript libraries live in the project root or dedicated folders (`css`, etc.), with user-facing images stored in `images/` and shared JavaScript collected under `frontend/js/`.
