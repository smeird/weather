    (function() {
        ...
        var _f = "portrait";
        var _10 = "landscape";
        window.iui = {logging: false, busy: false, animOn: true, ajaxErrHandler: null, httpHeaders: {"X-Requested-With": "XMLHttpRequest"}, showPage: function(_11, _12) {
                if (_11) {
                    if (_11 == _5) {
                ...
                function spbhCB(xhr) {
                    ...
                    if (xhr.readyState == 4) {
                        if ((xhr.status == 200 || xhr.status == 0) && !xhr.aborted) {
                            ...
                            sendEvent("beforeinsert", document.body, {fragment: _21});
                            if (_1e) {
            ...
            , param: function(o) {
                ...
                for (var i = 0; i < _2f.length; ++i) {
                    ...
                    if (_32.nodeType == 1) {
                        ...
                        sendEvent("afterinsert", document.body, {insertedNode: _34});
                ...
                sendEvent("afterinsertend", document.body, {fragment: _2e});
                if (_30) {
                    iui.showPage(_30);
                }
                ...
                return false;
            }, nativeUrlPatterns: [new RegExp("^http://maps.google.com/maps?"), new RegExp("^mailto:"), new RegExp("^tel:"), new RegExp("^http://www.youtube.com/watch\\?v="), new RegExp("^http://www.youtube.com/v/"), new RegExp("^javascript:"), new RegExp("^sms:"), new RegExp("^callto:")], hasClass: function(_38, _39) {
        ...
        function showForm(_5c) {
            _5c.addEventListener("click", function(_5d) {
            }, true);
        }
        ...
        function updatePage(_5f, _60) {
            ...
            if (_63) {
                ...
                if (_64 && !_5f.getAttribute("hideBackButton")) {
                    ...
                    _63.innerHTML = _64.title ? _64.title : "Back";
        ...
        function slidePages(_66, _67, _68) {
            ...
            clearInterval(_d);
            sendEvent("beforetransition", _66, {out: true});
            sendEvent("beforetransition", _67, {out: false});
            ...
            function slideDone() {
                ...
                sendEvent("aftertransition", _66, {out: true});
                sendEvent("aftertransition", _67, {out: false});
                if (_68) {
        ...
        function replaceElementWithFrag(_83, _84) {
            ...
            while (_84.firstChild) {
                ...
                sendEvent("afterinsert", document.body, {insertedNode: _87});
            }
            sendEvent("afterinsertend", document.body, {fragment: _84});
        }
        function $(id) {
